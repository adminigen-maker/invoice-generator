-- =====================================================================
-- Invoice UAE — Consolidated schema (all migrations 0001–0010)
--
-- One-shot install: paste into the Supabase SQL Editor and Run.
-- Migrations in order: extensions/types → RBAC → master data → sales
-- flow → invoicing/payments → inventory → RLS → seed → security
-- hardening → performance RPCs. Validated against a live Supabase project.
